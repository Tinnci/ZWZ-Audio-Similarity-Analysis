...
def setup_logging(output_dir):
    ...
    log_file = os.path.join(output_dir, "CQ_2_analysis_log.txt")
...
def save_results_to_file(output_dir, results):
    ...
    output_file = os.path.join(output_dir, "CQ_2_harmonic_distortion_analysis.txt")
...
def main():
    ...
    audio_paths = {
        ...
        'groundtruth': 'data/ZWZ_CQ_2_groundtruth.wav'
    }
