...
def setup_logging(output_dir):
    ...
    log_file = os.path.join(output_dir, "Adele_analysis_log.txt")
...
def save_results_to_file(output_dir, results):
    ...
    output_file = os.path.join(output_dir, "Adele_harmonic_distortion_analysis.txt")
...
def main():
    # 定义音频文件路径
    audio_paths = {
        'audio1': 'data/ZWZ_Adele_1.wav',
        'audio2': 'data/ZWZ_Adele_2.wav',
        'audio3': 'data/ZWZ_Adele_3.wav',
        'groundtruth': 'data/ZWZ_Adele_groundtruth.wav'
    }
